...
GLYPH_FONT_FAMILY="FiraCode Nerd Font Mono" # Set to your desired symbols font
...
PLAYERCTL_PATH = "/nix/store/hr977my77sniz5yldi13ixdfmrqk0igc-playerctl-2.4.1/bin/playerctl" # Path to playerctl, use which playerctl to find yours.
